...
<qgis minScale="100000000" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0" version="3.16.7-Hannover">
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="CD_UF" configurationFlags="None">
    ...
    <field name="NM_UF" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    <alias name="" field="CD_UF" index="0"/>
    <alias name="" field="NM_UF" index="1"/>
    <alias name="" field="SIGLA_UF" index="2"/>
    <alias name="" field="NM_REGIAO" index="3"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="CD_UF" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="NM_UF" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="SIGLA_UF" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="NM_REGIAO" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" field="CD_UF" exp=""/>
    <constraint desc="" field="NM_UF" exp=""/>
    <constraint desc="" field="SIGLA_UF" exp=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      <column name="SIGLA_UF" type="field" width="-1" hidden="0"/>
      <column type="actions" width="-1" hidden="1"/>
      <column name="CD_UF" type="field" width="-1" hidden="0"/>
      <column name="NM_UF" type="field" width="-1" hidden="0"/>
