...
<qgis minScale="100000000" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0" version="3.16.7-Hannover">
    ...
    <symbols>
      <symbol name="0" type="fill" clip_to_extent="1" force_rhr="0" alpha="1">
        <layer enabled="1" locked="0" pass="0" class="SimpleFill">
          ...
          <prop k="outline_color" v="206,254,12,255"/>
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="CD_MICRO" configurationFlags="None">
    ...
    <field name="NM_MICRO" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    <alias name="" field="CD_MICRO" index="0"/>
    <alias name="" field="NM_MICRO" index="1"/>
    <alias name="" field="SIGLA" index="2"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" expression="" field="CD_MICRO"/>
    <default applyOnUpdate="0" expression="" field="NM_MICRO"/>
    <default applyOnUpdate="0" expression="" field="SIGLA"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="CD_MICRO" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="NM_MICRO" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="SIGLA" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" field="CD_MICRO" exp=""/>
    <constraint desc="" field="NM_MICRO" exp=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="CD_MICRO" type="field" width="-1" hidden="0"/>
      <column name="NM_MICRO" type="field" width="-1" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="CD_MICRO" editable="1"/>
    <field name="CD_MUN" editable="1"/>
    <field name="NM_MICRO" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="CD_MICRO" labelOnTop="0"/>
    <field name="CD_MUN" labelOnTop="0"/>
    <field name="NM_MICRO" labelOnTop="0"/>
