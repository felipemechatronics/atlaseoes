...
<qgis minScale="100000000" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0" version="3.16.7-Hannover">
    ...
    <symbols>
      <symbol name="0" type="fill" clip_to_extent="1" force_rhr="0" alpha="1">
        <layer enabled="1" locked="0" pass="0" class="SimpleFill">
          ...
          <prop k="outline_color" v="63,16,10,255"/>
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="CD_RGINT" configurationFlags="None">
    ...
    <field name="NM_RGINT" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <constraints>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="CD_RGINT" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="NM_RGINT" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="SIGLA" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" field="CD_RGINT" exp=""/>
    <constraint desc="" field="NM_RGINT" exp=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="CD_RGINT" type="field" width="-1" hidden="0"/>
      <column name="NM_RGINT" type="field" width="-1" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="CD_RGI" editable="1"/>
    <field name="CD_RGINT" editable="1"/>
    <field name="NM_MUN" editable="1"/>
    <field name="NM_RGI" editable="1"/>
    <field name="NM_RGINT" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="CD_RGINT" labelOnTop="0"/>
    <field name="NM_MUN" labelOnTop="0"/>
    <field name="NM_RGI" labelOnTop="0"/>
    <field name="NM_RGINT" labelOnTop="0"/>
