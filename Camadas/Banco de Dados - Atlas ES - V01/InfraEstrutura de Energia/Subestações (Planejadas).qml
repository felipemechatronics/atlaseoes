...
<qgis minScale="100000000" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyDrawingTol="1" readOnly="0" version="3.16.7-Hannover">
  ...
  <fieldConfiguration>
    ...
    <field name="Ano_Opera" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="Ano_Opera" index="3"/>
    <alias name="" field="Tensao" index="4"/>
    <alias name="" field="Situacao" index="5"/>
    <alias name="" field="CEG" index="6"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" expression="" field="OBJECTID"/>
    <default applyOnUpdate="0" expression="" field="Id"/>
    <default applyOnUpdate="0" expression="" field="Nome"/>
    <default applyOnUpdate="0" expression="" field="Ano_Opera"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="Ano_Opera" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="Ano_Opera" exp=""/>
