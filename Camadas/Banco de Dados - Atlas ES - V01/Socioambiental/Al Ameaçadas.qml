...
<qgis minScale="100000000" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0" version="3.16.7-Hannover">
  ...
  <fieldConfiguration>
    ...
    <field name="TARGET_FID" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    <alias name="" field="Join_Count" index="0"/>
    <alias name="" field="TARGET_FID" index="1"/>
    <alias name="" field="Id" index="2"/>
    <alias name="" field="Id_Grade" index="3"/>
    <alias name="" field="Presenca" index="4"/>
    <alias name="" field="UF" index="5"/>
    <alias name="" field="Nome" index="6"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" expression="" field="Join_Count"/>
    <default applyOnUpdate="0" expression="" field="TARGET_FID"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="TARGET_FID" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="TARGET_FID" exp=""/>
