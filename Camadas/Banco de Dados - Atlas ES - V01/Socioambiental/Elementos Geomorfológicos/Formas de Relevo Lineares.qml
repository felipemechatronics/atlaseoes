...
<qgis minScale="100000000" maxScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyLocal="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" readOnly="0" version="3.16.7-Hannover">
    ...
    <symbols>
      <symbol name="0" type="line" clip_to_extent="1" force_rhr="0" alpha="1">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop k="line_color" v="90,38,153,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="cd_grupo" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="id_forma_s" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="forma_simb" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="cd_grupo" index="2"/>
    <alias name="" field="grupo" index="3"/>
    <alias name="" field="id_forma_s" index="4"/>
    <alias name="" field="forma_simb" index="5"/>
    <alias name="" field="geocodigo" index="6"/>
    <alias name="" field="compr" index="7"/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" expression="" field="id1"/>
    <default applyOnUpdate="0" expression="" field="cd_fcim"/>
    <default applyOnUpdate="0" expression="" field="cd_grupo"/>
    <default applyOnUpdate="0" expression="" field="grupo"/>
    <default applyOnUpdate="0" expression="" field="id_forma_s"/>
    <default applyOnUpdate="0" expression="" field="forma_simb"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="cd_grupo" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="grupo" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="id_forma_s" exp_strength="0"/>
    <constraint notnull_strength="0" constraints="0" unique_strength="0" field="forma_simb" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint desc="" field="cd_grupo" exp=""/>
    <constraint desc="" field="grupo" exp=""/>
    <constraint desc="" field="id_forma_s" exp=""/>
    <constraint desc="" field="forma_simb" exp=""/>
  ...
  <attributetableconfig sortExpression="" sortOrder="0" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column name="cd_grupo" type="field" width="-1" hidden="0"/>
      <column name="grupo" type="field" width="-1" hidden="0"/>
      <column name="id_forma_s" type="field" width="-1" hidden="0"/>
      <column name="forma_simb" type="field" width="-1" hidden="0"/>
